...
<body>
	<div id="wrapper">
        ...
        <div class="container" style="margin-top:50px">
            <div class="row">
                <div class="jumbotron">
                    <h4>Keterangan Denda Pengembalian</h4>
                    <p>Denda Rp.200.000 berkelipatan setiap hari setelah melewati tanggal batas sewa !</p>
                </div>
            </div>
        </div>	
                ...
                if(mysqli_num_rows($sql) > 0){
                    ...
                    while($data = mysqli_fetch_assoc($sql)){
                        ...
                        <tr>
                            ...
                            <td>'.$data['total'].'</td>
                            <td><a href="aksipengembalian.php?id_sewa='.$data['id_sewa'].'" class="badge badge-warning">Pemgembalian</a></td>
                        </tr>
                        ';
                        $no++;
                    }
    ...
    <div class="container" style="margin-top:20px">
        ...
        <table class="table table-striped table-hover table-sm table-bordered">
            ...
            <tbody>
                ...
                include 'koneksi.php';
                //query ke database SELECT tabel mahasiswa urut berdasarkan id yang paling besar
                $sql = mysqli_query($koneksi, "SELECT * FROM 06_pengembalian") or die(mysqli_error($koneksi));
                //jika query diatas menghasilkan nilai > 0 maka menjalankan script di bawah if...
                if(mysqli_num_rows($sql) > 0){
                    //membuat variabel $no untuk menyimpan nomor urut
                    $no = 1;
